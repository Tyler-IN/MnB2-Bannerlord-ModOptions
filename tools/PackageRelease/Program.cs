    ...
    static void Main(string[] args) {
      ...
      using (var proc = new Process()) {
        proc.StartInfo = new ProcessStartInfo {
          FileName ="git",
          Arguments = "archive --prefix=ModOptions/ -o ModOptions.zip -9 HEAD",
      ...
      using var fs = File.Open("ModOptions.zip", FileMode.Open);
      ...
      foreach (var filePath in Directory.EnumerateFiles(dir)) {
        ...
        var ze = za.CreateEntry("ModOptions/bin/Win64_Shipping_Client/" + fi.Name, CompressionLevel.Optimal);
